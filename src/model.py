...
class Config(object):
    def __init__(self, dim, n_layer, cutoff_l, cutoff_g):
        self.dim = dim
        self.n_layer = n_layer
        self.cutoff_l = cutoff_l  # for PAMNet
        self.cutoff_g = cutoff_g  # for PAMNet
        self.cutoff = cutoff_g  # for MXMNet
        self.dataset = 'QM9'  # for PAMNet


class Config_GNN(object):
    def __init__(self, hidden_channels, num_interactions, cutoff):
        self.hidden_channels = hidden_channels
        self.num_interactions = num_interactions
        self.cutoff = cutoff  # for MXMNet
